...
public class MyHorizontalScrollView extends HorizontalScrollView {
    ...
    public interface SizeCallback {
         ...
         * 
         * @param idxIndex of the View.
         *           
         * @param  Width of the parent View.
         *           
         * @param  Height of the parent View.
         *          
         * @param dimsdims[0] should be set to View width. dims[1] should be set to View height.
         *            
         */
