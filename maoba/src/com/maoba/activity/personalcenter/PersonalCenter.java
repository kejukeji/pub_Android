...
public class PersonalCenter extends BaseActivity implements OnClickListener {
    ...
    private TextView tvAge,tvAddress,tvNickName;
	...
	private void findView() {
        ...
        homeView =inflater.inflate(R.layout.personal_center, null);
		...
		viewMycollect =(LinearLayout)homeView.findViewById(R.id.viewMyCollect);
		viewMyNews =(LinearLayout)homeView.findViewById(R.id.viewMyNews);
		tvAge =(TextView)homeView.findViewById(R.id.tvAge);
		tvAddress =(TextView)homeView.findViewById(R.id.tvAddress);
	    tvNickName =(TextView)homeView.findViewById(R.id.tvNickName);
	    ivUserPhoto =(ImageView)homeView.findViewById(R.id.ivUserPhoto);
